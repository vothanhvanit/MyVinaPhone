...
public class JDBCModel {
    ...
    public Connection getConnectionOf() {
        ...
        //JDBCObject objEntity = new JDBCObject("103.97.124.25", "sa", "Dhnv@btn2020", "vnp_btn", "1433");
        JDBCObject objEntity = new JDBCObject("123.30.236.79", "vinaphone_btn", "vnp@btn@#$1505%2020^^!", "vnp_btn", "1433");
        try {
